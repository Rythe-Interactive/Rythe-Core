...
namespace rythe::core::ecs
{
    ...
    template<typename component_type, typename... component_types>
    inline R_ALWAYS_INLINE archetype<component_type, component_types...>::archetype(const handle_group& handles) noexcept : owner(std::get<0>(handles).owner), underlying(handles)
    {
    }

    template<typename component_type, typename... component_types>
    inline R_ALWAYS_INLINE archetype<component_type, component_types...>::archetype(const component_type& comp, const component_types&... comps) noexcept : owner(), underlying(std::make_tuple(std::cref(comp), std::cref(comps)...))
    {
    }
    ...
    template<typename component_type, typename... component_types>
    template<typename T>
    inline R_ALWAYS_INLINE T& archetype<component_type, component_types...>::get()
    {
        return std::get<component<T>>(std::get<handle_group>(underlying));
    }

    template<typename component_type, typename... component_types>
    inline R_ALWAYS_INLINE std::tuple<component_type&, component_types&...> archetype<component_type, component_types...>::get()
    {
    ...
    inline R_ALWAYS_INLINE rsl::element_at_t<I, component_type, component_types...>& archetype<component_type, component_types...>::get()
    {
        return std::get<I>(std::get<handle_group>(underlying));
    }

    template<typename component_type, typename... component_types>
    inline R_ALWAYS_INLINE std::tuple<component<component_type>, component<component_types>...> archetype<component_type, component_types...>::handles()
    {
        return std::get<handle_group>(underlying);
    }

    template<typename component_type, typename... component_types>
    inline R_ALWAYS_INLINE std::tuple<const component<component_type>, const component<component_types>...>  archetype<component_type, component_types...>::handles() const
    {
    ...
    template<typename component_type, typename... component_types>
    inline R_ALWAYS_INLINE std::tuple<component_type&, component_types&...> archetype<component_type, component_types...>::values()
    {
        return get();
    }

    template<typename component_type, typename... component_types>
    inline R_ALWAYS_INLINE bool archetype<component_type, component_types...>::valid() const
    {
        return std::apply([](auto&&... args) {return(args.valid() && ...); }, std::get<handle_group>(underlying));
    }

    template<typename component_type, typename... component_types>
    inline R_ALWAYS_INLINE archetype<component_type, component_types...>::operator bool() const
    {
        return valid();
    }
    ...
    template<typename component_type, typename... component_types>
    inline R_ALWAYS_INLINE std::tuple<component_type&, component_types&...> archetype<component_type, component_types...>::create(entity ent)
    {
    ...
    inline R_ALWAYS_INLINE std::tuple<component_type&, component_types&...> archetype<component_type, component_types...>::create(entity ent, component_type0&& value, component_typeN&&... valueN)
    {
    ...
    template<typename component_type, typename... component_types>
    inline R_ALWAYS_INLINE std::tuple<component_type&, component_types&...> archetype<component_type, component_types...>::create(entity ent, archetype&& value)
    {
    ...
    template<typename component_type, typename... component_types>
    inline R_ALWAYS_INLINE std::tuple<component_type&, component_types&...> archetype<component_type, component_types...>::get(entity ent)
    {
        return Registry::template getComponent<component_type, component_types...>(ent);
    }

    template<typename component_type, typename... component_types>
    inline R_ALWAYS_INLINE std::tuple<component<component_type>, component<component_types>...> archetype<component_type, component_types...>::get_handles(entity ent)
    {
        return std::make_tuple(component<component_type>{ {}, ent }, component<component_types>{ {}, ent }...);
    }

    template<typename component_type, typename... component_types>
    inline R_ALWAYS_INLINE std::tuple<const component<component_type>, const component<component_types>...> archetype<component_type, component_types...>::get_const_handles(entity ent)
    {
    ...
    template<typename component_type, typename... component_types>
    inline R_ALWAYS_INLINE void archetype<component_type, component_types...>::destroy(entity ent)
    {
        Registry::template destroyComponent<component_type, component_types...>(ent);
    }

    template<typename component_type, typename... component_types>
    inline R_ALWAYS_INLINE bool archetype<component_type, component_types...>::has(entity ent)
    {
