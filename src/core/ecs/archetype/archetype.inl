...
namespace rythe::core::ecs
{
    ...
    template<typename component_type, typename... component_types>
    inline rythe_always_inline archetype<component_type, component_types...>::archetype(const handle_group& handles) noexcept : owner(std::get<0>(handles).owner), underlying(handles)
    {
    }

    template<typename component_type, typename... component_types>
    inline rythe_always_inline archetype<component_type, component_types...>::archetype(const component_type& comp, const component_types&... comps) noexcept : owner(), underlying(std::make_tuple(std::cref(comp), std::cref(comps)...))
    {
    }
