...
namespace rythe::core::ecs
{
	...
	inline rsl::id_type FilterRegistry::generateFilterImpl()
	{
		// Get the id.
		constexpr rsl::id_type id = generateId<component_types...>();
	...
	template <typename... component_types>
	inline rsl::id_type FilterRegistry::generateFilter()
	{
		static const rsl::id_type id = generateFilterImpl<component_types...>();
		return id;
	}
