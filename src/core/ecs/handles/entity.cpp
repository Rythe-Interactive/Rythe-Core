...
namespace rythe::core::ecs
{
	struct child_iterator::impl
	{
		...
		impl(entity_set::iterator it)
			: iterator(it)
		{
		}
	};

	child_iterator::child_iterator(impl* implptr)
		: m_pimpl(implptr)
	{
	}
	...
	struct const_child_iterator::impl
	{
		...
		impl(entity_set::const_iterator it)
			: iterator(it)
		{
		}
	};

	const_child_iterator::const_child_iterator(impl* implptr)
		: m_pimpl(implptr)
	{
	}
	...
	struct child_reverse_iterator::impl
	{
		...
		impl(entity_set::reverse_iterator it)
			: iterator(it)
		{
		}
	};

	child_reverse_iterator::child_reverse_iterator(impl* implptr)
		: m_pimpl(implptr)
	{
	}
	...
	struct const_child_reverse_iterator::impl
	{
		...
		impl(entity_set::const_reverse_iterator it)
			: iterator(it)
		{
		}
	};

	const_child_reverse_iterator::const_child_reverse_iterator(impl* implptr)
		: m_pimpl(implptr)
	{
	}
	...
	void entity::set_parent(rsl::id_type parent)
	{
		if (data->parent)
	...
	void entity::add_child(rsl::id_type child)
	{
	...
	void entity::remove_child(rsl::id_type child)
	{
	...
	entity entity::get_child(rsl::size_type index) const
	{
