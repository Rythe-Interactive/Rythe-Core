...
#pragma endregion
    ...
    public:
         ...
         */
        L_NODISCARD operator rsl::id_type () const noexcept;
        ...
        L_NODISCARD std::unordered_set<rsl::id_type>& component_composition();
        L_NODISCARD const std::unordered_set<rsl::id_type>& component_composition() const;
         ...
         */
        L_NODISCARD entity get_child(rsl::size_type index) const;
