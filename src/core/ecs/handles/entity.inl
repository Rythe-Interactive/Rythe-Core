...
namespace std
{
    inline L_ALWAYS_INLINE size_t hash<rythe::core::ecs::entity>::operator()(rythe::core::ecs::entity const& handle) const noexcept
    {
...
namespace rythe::core::ecs
{
    ...
    template<>
    inline L_ALWAYS_INLINE bool entity::operator==<rsl::id_type>(rsl::id_type id) const
    {
