...
namespace rythe::core::ecs
{
    ...
    template<typename... ComponentTypes>
    L_NODISCARD inline L_ALWAYS_INLINE rsl::size_type filter<ComponentTypes...>::size() noexcept
    {
    ...
    template<typename... ComponentTypes>
    L_NODISCARD inline L_ALWAYS_INLINE rsl::size_type filter<ComponentTypes...>::count(entity val)
    {
        return FilterRegistry::getList(id).count(val);
    }

    template<typename... ComponentTypes>
    L_NODISCARD inline L_ALWAYS_INLINE rsl::size_type filter<ComponentTypes...>::contains(entity val)
    {
    ...
    template<typename... ComponentTypes>
    L_NODISCARD inline L_ALWAYS_INLINE entity& filter<ComponentTypes...>::at(rsl::size_type index)
    {
        return FilterRegistry::getList(id).at(index);
    }

    template<typename... ComponentTypes>
    L_NODISCARD inline L_ALWAYS_INLINE entity& filter<ComponentTypes...>::operator[](rsl::size_type index)
    {
        return FilterRegistry::getList(id).at(index);
    }
