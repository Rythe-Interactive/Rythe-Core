...
namespace rythe::core::ecs
{
	...
	{
		return std::make_tuple(detail::_create_component_ref(target, std::forward<ComponentType0>(value0)), detail::_create_component_ref(target, std::forward<ComponentType1>(value1)), detail::_create_component_ref(target, std::forward<ComponentTypeN>(valueN))...);
	}
	...
	{
		return std::make_tuple(detail::_create_component_ref(target, value0), detail::_create_component_ref(target, value1), detail::_create_component_ref(target, valueN)...);
	}
