...
namespace rythe::core::ecs
{
    ...
    inline rythe_always_inline void component_pool<component_type>::reserve(rsl::size_type size)
    {
        m_components.reserve(size);
    }

    template<typename component_type>
    inline rythe_always_inline void component_pool<component_type>::clear()
    {
        m_components.clear();
    }

    template<typename component_type>
    inline rythe_always_inline void* component_pool<component_type>::create_component(entity target)
    {
    ...
    inline rythe_always_inline component_type& component_pool<component_type>::create_component(entity target, Args&& ...args)
    {
    ...
    template<typename component_type>
    inline rythe_always_inline bool component_pool<component_type>::contains(entity target) const
    {
        return m_components.contains(target);
    }

    template<typename component_type>
    inline rythe_always_inline void component_pool<component_type>::destroy_component(entity target)
    {
    ...
    template<typename component_type>
    inline rythe_always_inline void* component_pool<component_type>::get_component(entity target)
    {
        return &(m_components.at(target));
    }

    template<typename component_type>
    inline rythe_always_inline const void* component_pool<component_type>::get_component(entity target) const
    {
        return &(m_components.at(target));
    }

    template<typename component_type>
    inline rythe_always_inline void component_pool<component_type>::fill_container(component_container<component_type>& container, entity_set& entities)
    {
