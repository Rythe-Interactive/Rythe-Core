...
namespace rythe::core
{
	...
	public:
		...
		virtual common::result<asset_ptr> load(rsl::id_type nameHash, const fs::view& file, const import_cfg& settings) override { return rythe_exception_msg("Tried to use a faux loader"); }
