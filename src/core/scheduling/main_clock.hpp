...
namespace rsl
{
    ...
    template<>
    struct rsl::stopwatch<main_clock_time, std::chrono::high_resolution_clock> : public rythe::core::EngineSubSystem<rsl::stopwatch<main_clock_time, std::chrono::high_resolution_clock>>
    {
    public:
