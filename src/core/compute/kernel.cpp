...
namespace rythe::core::compute
{
	...
	Kernel& Kernel::local(rsl::size_type s)
	{
	...
	Kernel& Kernel::global(rsl::size_type s0, rsl::size_type s1)
	{
		m_global_size = d2{s0, s1};
		return *this;
	}
	Kernel& Kernel::global(rsl::size_type s0, rsl::size_type s1, rsl::size_type s2)
	{
