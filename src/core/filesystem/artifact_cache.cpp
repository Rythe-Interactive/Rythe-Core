...
namespace rythe::core::filesystem
{
	...
	void artifact_cache::gc()
	{
		...
		if (m_caches.size() < (gc_keep + gc_hist))
			return;
		...
		composer([&score_heap]([[maybe_unused]] auto& p, auto score)
		{
