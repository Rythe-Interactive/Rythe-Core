...
namespace rythe::core
{
    ...
    public:
        ...
        exception(rsl::cstring file, rsl::uint line, rsl::cstring func) : m_file(file), m_line(line), m_func(func), m_message("Args generic exception occurred.") {}
        exception(const std::string& msg, rsl::cstring file, rsl::uint line, rsl::cstring func) : m_file(file), m_line(line), m_func(func), m_message(msg) {}
...
#pragma region invalid fetch
    ...
    public:
        ...
        invalid_fetch_error(rsl::cstring file, rsl::uint line, rsl::cstring func) : exception("Invalid fetch occurred.", file, line, func) {}
        invalid_fetch_error(const std::string& msg, rsl::cstring file, rsl::uint line, rsl::cstring func) : exception(msg, file, line, func) {}
    };
    ...
    public:
        ...
        invalid_component_error(rsl::cstring file, rsl::uint line, rsl::cstring func) : invalid_fetch_error("Component invalid.", file, line, func) {}
        invalid_component_error(const std::string& msg, rsl::cstring file, rsl::uint line, rsl::cstring func) : invalid_fetch_error(msg, file, line, func) {}
    };
    ...
    public:
        ...
        component_destroyed_error(rsl::cstring file, rsl::uint line, rsl::cstring func) : invalid_component_error("Component no longer exists.", file, line, func) {}
        component_destroyed_error(const std::string& msg, rsl::cstring file, rsl::uint line, rsl::cstring func) : invalid_component_error(msg, file, line, func) {}
    };
    ...
    public:
        ...
        invalid_entity_error(rsl::cstring file, rsl::uint line, rsl::cstring func) : invalid_fetch_error("Entity invalid.", file, line, func) {}
        invalid_entity_error(const std::string& msg, rsl::cstring file, rsl::uint line, rsl::cstring func) : invalid_fetch_error(msg, file, line, func) {}
    };
    ...
    public:
        ...
        entity_not_found_error(rsl::cstring file, rsl::uint line, rsl::cstring func) : invalid_entity_error("Entity does not exist.", file, line, func) {}
        entity_not_found_error(const std::string& msg, rsl::cstring file, rsl::uint line, rsl::cstring func) : invalid_entity_error(msg, file, line, func) {}
    };
#pragma endregion
...
#pragma region invalid creation
    ...
    public:
        ...
        invalid_creation_error(rsl::cstring file, rsl::uint line, rsl::cstring func) : exception("Creation invalid.", file, line, func) {}
        invalid_creation_error(const std::string& msg, rsl::cstring file, rsl::uint line, rsl::cstring func) : exception(msg, file, line, func) {}
    };
    ...
    public:
        ...
        entity_exists_error(rsl::cstring file, rsl::uint line, rsl::cstring func) : invalid_creation_error("Entity already exist.", file, line, func) {}
        entity_exists_error(const std::string& msg, rsl::cstring file, rsl::uint line, rsl::cstring func) : invalid_creation_error(msg, file, line, func) {}
    };
    ...
    public:
        ...
        component_exists_error(rsl::cstring file, rsl::uint line, rsl::cstring func) : invalid_creation_error("Component already exist.", file, line, func) {}
        component_exists_error(const std::string& msg, rsl::cstring file, rsl::uint line, rsl::cstring func) : invalid_creation_error(msg, file, line, func) {}
    };
#pragma endregion
...
#pragma region invalid type
    ...
    public:
       ...
       invalid_type_error(rsl::cstring file, rsl::uint line, rsl::cstring func) : exception("Type invalid.", file, line, func) {}
       invalid_type_error(const std::string& msg, rsl::cstring file, rsl::uint line, rsl::cstring func) : exception(msg, file, line, func) {}
    };
    ...
    public:
        ...
        unknown_component_error(rsl::cstring file, rsl::uint line, rsl::cstring func) : invalid_type_error("Unknown component type.", file, line, func) {}
        unknown_component_error(const std::string& msg, rsl::cstring file, rsl::uint line, rsl::cstring func) :invalid_type_error(msg, file, line, func) {}
    };
    ...
    public:
        ...
        unknown_system_error(rsl::cstring file, rsl::uint line, rsl::cstring func) :invalid_type_error("Unknown system type.", file, line, func) {}
        unknown_system_error(const std::string& msg, rsl::cstring file, rsl::uint line, rsl::cstring func) :invalid_type_error(msg, file, line, func) {}
    };
#pragma endregion
...
#pragma region filesystem
    ...
    public:
        ...
        fs_error(rsl::cstring file, rsl::uint line, rsl::cstring func) : exception("Filesystem Adapter failed", file, line, func) {}
        fs_error(const std::string& msg, rsl::cstring file, rsl::uint line, rsl::cstring func) : exception(msg, file, line, func) {}
    };
#pragma endregion 
