...
namespace rythe::core
{
    ...
    public:
        ...
        using sparse_container = sparse_type<value_type, rsl::size_type, hash_type>;
    ...
    public:
        ...
        [[nodiscard]] reverse_itr_range reverse_range() noexcept { return rsl::pair_range{ rbegin(), rend() }; }
        [[nodiscard]] const_reverse_itr_range reverse_range() const noexcept { return rsl::pair_range{ crbegin(), crend() }; }
...
#pragma region count
         ...
         * @returns rsl::size_type Amount of items of the same value (either 0 or 1).
         ...
         */
        [[nodiscard]] rsl::size_type count(value_const_reference val) const
        {
            return contains(val);
        }
...
#pragma region contains
        ...
        [[nodiscard]] bool contains(value_const_reference val) const
        {
            ...
            const rsl::size_type& sparseVal = m_sparse.at(val);
...
#pragma region operator[]
         ...
         */
        [[nodiscard]] value_reference operator[](rsl::size_type&& index)
        {
         ...
         * @param index Index of item in dense container.
         */
        [[nodiscard]] value_reference operator[](const rsl::size_type& index)
        {
            if (index < 0 || index > m_size)
                throw std::out_of_range("hashed_sparse_set subscript out of range");
            return m_dense[index];
         ...
         * @param index Index of item in dense container.
         */
        [[nodiscard]] value_const_reference operator[](rsl::size_type&& index) const
        {
            if (index < 0 || index > m_size)
                throw std::out_of_range("hashed_sparse_set subscript out of range");
            return m_dense[index];
         ...
         * @param index Index of item in dense container.
         */
        [[nodiscard]] value_const_reference operator[](const rsl::size_type& index) const
        {
            if (index < 0 || index > m_size)
                throw std::out_of_range("hashed_sparse_set subscript out of range");
            return m_dense[index];
...
#pragma region at
         ...
         * @param index Index of item in dense container.
         */
        [[nodiscard]] value_reference at(rsl::size_type&& index)
        {
            if (index < 0 || index > m_size)
                throw std::out_of_range("hashed_sparse_set subscript out of range");
            return m_dense[index];
         ...
         * @param index Index of item in dense container.
         */
        [[nodiscard]] value_reference at(const rsl::size_type& index)
        {
            if (index < 0 || index > m_size)
                throw std::out_of_range("hashed_sparse_set subscript out of range");
            return m_dense[index];
         ...
         * @param index Index of item in dense container.
         */
        [[nodiscard]] value_const_reference at(rsl::size_type&& index) const
        {
            if (index < 0 || index > m_size)
                throw std::out_of_range("hashed_sparse_set subscript out of range");
            return m_dense[index];
         ...
         * @param index Index of item in dense container.
         */
        [[nodiscard]] value_const_reference at(const rsl::size_type& index) const
        {
            if (index < 0 || index > m_size)
                throw std::out_of_range("hashed_sparse_set subscript out of range");
            return m_dense[index];
...
#pragma endregion
         ...
         */
        rsl::size_type erase(value_const_reference val)
        {
            if (contains(val))
            {
