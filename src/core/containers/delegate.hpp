...
#pragma region element access
        L_NODISCARD reference at(rsl::size_type index) { return m_invocationList.at(index); }
        L_NODISCARD const_reference at(rsl::size_type index) const { return m_invocationList.at(index); }

        L_NODISCARD reference operator[](rsl::size_type index) { return m_invocationList[index]; }
        L_NODISCARD const_reference operator[](rsl::size_type index) const { return m_invocationList[index]; }
...
#pragma region capacity
        ...
        L_NODISCARD rsl::size_type size() const noexcept { return m_invocationList.size(); }
        L_NODISCARD rsl::size_type max_size() const noexcept { return m_invocationList.max_size(); }
        void reserve(rsl::size_type newSize) { m_invocationList.reserve(newSize); }
        L_NODISCARD rsl::size_type capacity() const noexcept { return m_invocationList.capacity(); }
        void shrink_to_fit() { m_invocationList.shrink_to_fit(); }
#pragma endregion

#pragma region modifiers
#pragma region assign
        void assign(rsl::size_type count, const_reference value) { m_invocationList.assign(count, value); }
...
#pragma region insert
        ...
        iterator insert(const_iterator pos, rsl::size_type count, const_reference value) { return m_invocationList.insert(pos, count, value); }
        template<typename InputIt>
...
#pragma region erase
        rsl::size_type erase(const invocation_type& value)
        {
        ...
        template <typename owner_type, return_type(owner_type::* const method_ptr)(Args...)>
        rsl::size_type erase(owner_type* const object_ptr)
        {
            auto size = m_invocationList.size();
            m_invocationList.erase(std::remove(m_invocationList.begin(), m_invocationList.end(),
        ...
        template <typename owner_type, return_type(owner_type::* const method_ptr)(Args...) const>
        rsl::size_type erase(owner_type const* const object_ptr)
        {
            auto size = m_invocationList.size();
            m_invocationList.erase(std::remove(m_invocationList.begin(), m_invocationList.end(),
                invocation_type::template from<owner_type, method_ptr>(object_ptr)
        ...
        template <typename owner_type, return_type(owner_type::* const method_ptr)(Args...)>
        rsl::size_type erase(owner_type& object)
        {
            auto size = m_invocationList.size();
            m_invocationList.erase(std::remove(m_invocationList.begin(), m_invocationList.end(),
        ...
        template <typename owner_type, return_type(owner_type::* const method_ptr)(Args...) const>
        rsl::size_type erase(owner_type const& object)
        {
            auto size = m_invocationList.size();
            m_invocationList.erase(std::remove(m_invocationList.begin(), m_invocationList.end(),
                invocation_type::template from<owner_type, method_ptr>(object)
        ...
        rsl::size_type erase(return_type(* const function_ptr)(Args...))
        {
            auto size = m_invocationList.size();
            m_invocationList.erase(std::remove(m_invocationList.begin(), m_invocationList.end(),
        ...
        template <typename owner_type>
        rsl::size_type erase(owner_type* const object_ptr, return_type(owner_type::* const method_ptr)(Args...))
        {
            auto size = m_invocationList.size();
            m_invocationList.erase(std::remove(m_invocationList.begin(), m_invocationList.end(),
        ...
        template <typename owner_type>
        rsl::size_type erase(owner_type const* const object_ptr, return_type(owner_type::* const method_ptr)(Args...) const)
        {
            auto size = m_invocationList.size();
            m_invocationList.erase(std::remove(m_invocationList.begin(), m_invocationList.end(),
                invocation_type::template from<owner_type>(object_ptr, method_ptr)
        ...
        template <typename owner_type>
        rsl::size_type erase(owner_type& object, return_type(owner_type::* const method_ptr)(Args...))
        {
            auto size = m_invocationList.size();
            m_invocationList.erase(std::remove(m_invocationList.begin(), m_invocationList.end(),
        ...
        template <typename owner_type>
        rsl::size_type erase(owner_type const& object, return_type(owner_type::* const method_ptr)(Args...) const)
        {
            auto size = m_invocationList.size();
            m_invocationList.erase(std::remove(m_invocationList.begin(), m_invocationList.end(),
                invocation_type::template from<owner_type>(object, method_ptr)
...
#pragma region resize
        void resize(rsl::size_type count) { m_invocationList.resize(count); }
        void resize(rsl::size_type count, const value_type& value) { m_invocationList.resize(count, value); }
#pragma endregion
...
#pragma endregion
        ...
        auto invoke_one(rsl::size_type index, Args... args) const
        {
            if constexpr (std::is_same_v<return_type, void>)
            {
...
namespace std
{
    ...
    struct hash<rythe::core::delegate<return_type(Args...)>>
    {
        size_t operator()(rythe::core::delegate<return_type(Args...)> const& d) const noexcept
        {
            auto const seed(hash<void*>()(d.object_ptr_));

            return hash<typename rythe::core::delegate<return_type(Args...)>::stub_ptr_type>()(
