...
namespace rythe::core::events
{
    ...
    private:
        ...
        std::unordered_map<rsl::id_type, multicast_delegate<void(event_base&)>> m_eventCallbacks;
    ...
    public:
         ...
         */
        static void bindToEvent(rsl::id_type id, const delegate<void(event_base&)>& callback);
         ...
         * @param callback Function to bind.
         */
        static void bindToEvent(rsl::id_type id, delegate<void(event_base&)>&& callback);
         ...
         * @param callback Function to bind.
         */
        static void unbindFromEvent(rsl::id_type id, const delegate<void(event_base&)>& callback);
    };
