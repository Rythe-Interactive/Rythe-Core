...
namespace rythe::core::assets
{
    ...
    template<typename AssetType>
    inline L_ALWAYS_INLINE common::result<asset<AssetType>> load(rsl::id_type nameHash, const std::string& name, const fs::view& file)
    {
        return AssetCache<AssetType>::load(nameHash, name, file);
    }

    template<typename AssetType>
    inline L_ALWAYS_INLINE common::result<asset<AssetType>> load(rsl::id_type nameHash, const std::string& name, const fs::view& file, const import_settings<AssetType>& settings)
    {
    ...
    template<typename AssetType>
    inline L_ALWAYS_INLINE async::async_operation<common::result<asset<AssetType>>> loadAsync(rsl::id_type nameHash, const std::string& name, const fs::view& file)
    {
        return AssetCache<AssetType>::loadAsync(nameHash, name, file);
    }

    template<typename AssetType>
    inline L_ALWAYS_INLINE async::async_operation<common::result<asset<AssetType>>> loadAsync(rsl::id_type nameHash, const std::string& name, const fs::view& file, const import_settings<AssetType>& settings)
    {
    ...
    template<typename AssetType>
    inline L_ALWAYS_INLINE asset<AssetType> create(rsl::id_type nameHash, const std::string& name)
    {
        return AssetCache<AssetType>::create(nameHash, name);
    }

    template<typename AssetType>
    inline L_ALWAYS_INLINE asset<remove_cvr_t<AssetType>> create(rsl::id_type nameHash, const std::string& name, AssetType&& src)
    {
        return AssetCache<remove_cvr_t<AssetType>>::create(nameHash, name, std::forward<AssetType>(src));
    }

    template<typename AssetType>
    inline L_ALWAYS_INLINE asset<AssetType> create(rsl::id_type nameHash, const std::string& name, const AssetType& src)
    {
        return AssetCache<AssetType>::create(nameHash, name, src);
    }

    template<typename AssetType, typename... Arguments>
    inline L_ALWAYS_INLINE asset<AssetType> create(rsl::id_type nameHash, const std::string& name, Arguments&&... args)
    {
    ...
    template<typename AssetType>
    inline L_ALWAYS_INLINE bool exists(rsl::id_type nameHash)
    {
    ...
    template<typename AssetType>
    inline L_ALWAYS_INLINE asset<AssetType> get(rsl::id_type nameHash)
    {
    ...
    template<typename AssetType>
    inline L_ALWAYS_INLINE void destroy(rsl::id_type nameHash)
    {
