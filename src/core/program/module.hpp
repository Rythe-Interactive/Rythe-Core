...
#define RYTHE_DECLARE_MODULE(module_name)                                                                                             \
    ...
    struct feature : public feature_base
    {
        ...
        inline const static rsl::hashed_string feature_hashed_name = // TODO(Glyn): hashes are not constexpr yet...
    ...
    public:
        ...
        rsl::memory_allocator& get_allocator() noexcept;
        const rsl::memory_allocator& get_allocator() const noexcept;
