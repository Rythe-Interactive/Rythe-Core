...
L_NODISCARD constexpr rythe::core::time::time_span<std::common_type_t<PrecisionType1, PrecisionType2>>
operator+(const rythe::core::time::time_span<PrecisionType1>& lhs, const rythe::core::time::time_span<PrecisionType2>& rhs)
noexcept(std::is_arithmetic_v<PrecisionType1>&& std::is_arithmetic_v<PrecisionType2>) /* strengthened */
{
    using common_span = rythe::core::time::time_span<std::common_type_t<PrecisionType1, PrecisionType2>>;
...
noexcept(std::is_arithmetic_v<PrecisionType1>&& std::is_arithmetic_v<PrecisionType2>) /* strengthened */
{
    return rythe::core::math::close_enough(lhs.duration.count(), rhs.duration.count());
}
