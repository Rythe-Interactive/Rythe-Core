...
#pragma region Quaternion
    ...
    {
        return detail::compute_division<typename quat_type0::scalar, quat_type0::size>::compute(a, b);
    }
    ...
    {
        return detail::compute_division<typename quat_type::scalar, quat_type::size>::compute(a, b);
    }
    ...
    {
        return a = detail::compute_division<typename quat_type0::scalar, quat_type0::size>::compute(a, b);
    }
    ...
    {
        return a = detail::compute_division<typename quat_type::scalar, quat_type::size>::compute(a, b);
    }
