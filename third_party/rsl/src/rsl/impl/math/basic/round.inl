...
namespace rsl::math
{
    namespace detail
    {
        ...
        [[nodiscard]] r_always_inline constexpr Target _round_impl_(T val) noexcept
        {
        ...
        struct compute_round<vector<Scalar, Size>, Mode>
        {
            ...
            [[nodiscard]] r_always_inline constexpr static auto compute(const value_type& val) noexcept
            {
        ...
        [[nodiscard]] r_always_inline constexpr auto _auto_adv_round_(T&& val) noexcept
        {
            using value_type = ::std::remove_cvref_t<T>;
